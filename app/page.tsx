...
function SectionHeader({
  ...
  return (
    <div className="mb-3.5">
      ...
      {sub && (
        <div className="text-ink/60 text-[13px] mt-0.5">
          {sub}
        </div>
      )}
    </div>
        ...
        <div className="surface rounded-3xl p-5 md:p-7 text-ink">
          <div className="flex items-end justify-between">
            <SectionHeader
              eyebrow="THE CHART"
              title="GIM TOP 100"
              sub="100 songs. 25 years. One GIM vibe."
            />

            <Link
              href="/top-100"
              className="text-clay text-[12.5px] font-bold flex items-center shrink-0"
            >
      ...
      <div className="px-5 md:px-8 pb-6">
        <div className="surface rounded-3xl p-5 md:p-7 text-ink">
          <SectionHeader
            ...
            sub="Every year had a soundtrack."
          />
                ...
                .map((s) => (
                  ...
                  >
                    <div
                      ...
                      style={{
                        background: `linear-gradient(150deg, ${cat.color}44, #FBF3E7)`,
                    ...
                    <div className="text-[12.5px] font-bold mt-1.5 truncate">
                      {s.title}
                    </div>
